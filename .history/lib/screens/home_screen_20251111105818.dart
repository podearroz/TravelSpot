...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadPlaces() async {
    ...
    final list = await SupabaseService.fetchPlaces(type: _filterType, cuisine: _filterCuisine);
    setState(() {
      _places = list;
      _loading = false;
    });
  ...
  Future<void> _openFilterDialog() async {
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            TextField(controller: cuisineCtrl, decoration: const InputDecoration(labelText: 'Culinária')),
          ],
        ),
        actions: [
    ...
    if (res == true) {
      ...
      _filterCuisine = cuisineCtrl.text.trim().isEmpty ? null : cuisineCtrl.text.trim();
      await _loadPlaces();
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [IconButton(onPressed: _openFilterDialog, icon: const Icon(Icons.filter_list))],
      ),
      body: _loading
