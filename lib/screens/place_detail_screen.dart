...
class _PlaceDetailScreenState extends State<PlaceDetailScreen> {
  ...
  Future<void> _submitReview() async {
    ...
    if (_pickedImage != null) {
      final fileName =
          '${widget.place.id}_${DateTime.now().millisecondsSinceEpoch}.jpg';
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('${widget.place.type ?? ''} • ${widget.place.cuisine ?? ''}',
            ...
            const Divider(),
            const Text('Adicionar avaliação',
            ...
            Row(children: [
              ElevatedButton(
                  onPressed: _pickImage, child: const Text('Escolher foto')),
              const SizedBox(width: 8),
